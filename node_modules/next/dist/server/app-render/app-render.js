...
async function renderToHTMLOrFlight(req, res, pagePath, query, renderOpts) {
    ...
    const { buildManifest , subresourceIntegrityManifest , serverActionsManifest , ComponentMod , dev , nextFontManifest , supportsDynamicHTML , nextConfigOutput , serverActionsSizeLimit  } = renderOpts;
