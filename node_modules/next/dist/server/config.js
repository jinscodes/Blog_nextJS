...
function assignDefaults(dir, userConfig, silent = false) {
    ...
    if (typeof ((_result_experimental2 = result.experimental) == null ? void 0 : _result_experimental2.serverActionsSizeLimit) !== "undefined") {
        const value = parseInt(result.experimental.serverActionsSizeLimit.toString());
