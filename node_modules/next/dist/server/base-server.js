        ...
        const doRender = async ()=>{
            ...
            const renderOpts = {
                ...
                ...isAppPath && this.nextConfig.experimental.appDir ? {
                    ...
                    serverActionsSizeLimit: this.nextConfig.experimental.serverActionsSizeLimit
                } : {},
                isDataReq,
                resolvedUrl,
                locale,
            ...
            (this.renderOpts.dev && ((_components_ComponentMod = components.ComponentMod) == null ? void 0 : _components_ComponentMod.routeModule) ? {
            ...
            if (match && (0, _routematch.isRouteMatch)(match, _routekind.RouteKind.APP_ROUTE)) {
                ...
                // above.
                result = await module1.render(req.originalRequest, res.originalResponse, {
                    page: pathname,
                    params: match.params,
                    query,
                    renderOpts
