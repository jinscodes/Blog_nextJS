...
;// CONCATENATED MODULE: ./src/assets/svg/Aws.svg
/* harmony default export */ const Aws = ({"src":"/_next/static/media/Aws.7142b4eb.svg","height":800,"width":800,"blurWidth":0,"blurHeight":0});
;// CONCATENATED MODULE: ./src/assets/svg/Cicd.svg
/* harmony default export */ const Cicd = ({"src":"/_next/static/media/Cicd.03a9c6a7.svg","height":225,"width":225,"blurWidth":0,"blurHeight":0});
...
// EXTERNAL MODULE: ./public/svg/Caret.svg
var Caret = __webpack_require__(85758);
...
;// CONCATENATED MODULE: ./public/svg/Error.svg
/* harmony default export */ const Error = ({"src":"/_next/static/media/Error.65663990.svg","height":225,"width":225,"blurWidth":0,"blurHeight":0});
;// CONCATENATED MODULE: ./public/svg/Express.svg
/* harmony default export */ const Express = ({"src":"/_next/static/media/Express.9cd20b33.svg","height":800,"width":800,"blurWidth":0,"blurHeight":0});
...
;// CONCATENATED MODULE: ./public/svg/WebCS.svg
/* harmony default export */ const WebCS = ({"src":"/_next/static/media/WebCS.cc9a1419.svg","height":512,"width":512,"blurWidth":0,"blurHeight":0});
...
const NavMenu = ({ datas, isMenu, setIsMenu, coordinates })=>{
    const svgList = {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: datas.class === isMenu && datas.menu.map((menu, idx)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)((link_default()), {
...
const NavClass = ({ datas, isMenu, setIsMenu })=>{
    const [coordinates, setCoordinates] = (0,react_.useState)(0);
    const setSubmenu = (classEle, event)=>{
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: datas.map((el, idx)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: (NavClass_module_default()).visible_menu,
                children: [
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
...
module.exports = {
	...
	"footer_content_container": "Footer_footer_content_container___Zesy",
	"waves": "Footer_waves__j4Xjc",
	"content_container": "Footer_content_container__hBs20",
	"recent_posts": "Footer_recent_posts__M3QdO",
	"img": "Footer_img__QuO1W",
	"popular_posts": "Footer_popular_posts__94y28",
	"reference": "Footer_reference__cQTCu",
...
module.exports = {
	...
	"copyright": "Nav_copyright__pCY0f",
	"caret": "Nav_caret__hXEf0",
	"arrowDown": "Nav_arrowDown__yPMMH"
};
...
module.exports = {
	...
	"visible_menu": "NavClass_visible_menu__8VFkM",
...
// Exports
module.exports = {
	"header": "FooterWaves_header__9aOz0",
	"waves": "FooterWaves_waves__h_2Hz",
	"move_forever": "FooterWaves_move_forever__gI5i8"
};
...
// EXTERNAL MODULE: ./src/components/Waves/FooterWaves.module.scss
var FooterWaves_module = __webpack_require__(31872);
var FooterWaves_module_default = /*#__PURE__*/__webpack_require__.n(FooterWaves_module);
;// CONCATENATED MODULE: ./src/components/Waves/FooterWaves.tsx


const FooterWaves = ()=>{
    return /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
        children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
            className: (FooterWaves_module_default()).header,
            children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("svg", {
                    className: (FooterWaves_module_default()).waves,
                    ...
                    children: [
                        /*#__PURE__*/ jsx_runtime_.jsx("defs", {
                            children: /*#__PURE__*/ jsx_runtime_.jsx("path", {
                                id: "gentle-wave",
                                className: (FooterWaves_module_default()).gentle_wave,
...
const Footer = async ()=>{
    const recentPosts = await (0,posts/* getRecentPosts */.no)();
    const popularPosts = await (0,posts/* getFeaturedPosts */.mH)();
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: (Footer_module_default()).footer,
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(FooterWaves, {}),
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: (Footer_module_default()).footer_content_container,
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        className: (Footer_module_default()).content_container,
                        children: [
                            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                className: (Footer_module_default()).recent_posts,
                                children: recentPosts.map((post)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                        children: [
                                            /*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
                            ...
                            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                className: (Footer_module_default()).popular_posts,
                                children: popularPosts.map((post)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                        children: [
                                            /*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
                                                src: `/images/posts/${post.path}.png`,
                                                alt: post.title,
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("p", {
                className: (Footer_module_default()).reference,
                children: "\xa9 Copyright 2023 Jay Han"
            })
        ]
    });
};
...
const proxy = (0,module_proxy.createProxy)(String.raw`/Users/hanjinsung/Desktop/Repository/blog_nextJS/src/components/NavCategory/NavCategory.tsx`)
...
;// CONCATENATED MODULE: ./src/assets/images/myself.png
/* harmony default export */ const myself = ({"src":"/_next/static/media/myself.e2bb6821.png","height":355,"width":372,"blurDataURL":"data:image/png;base64,","blurWidth":8,"blurHeight":8});
;// CONCATENATED MODULE: ./src/assets/svg/Category.svg
...
const Nav = ()=>{
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("header", {
        ...
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("p", {
                className: (Nav_module_default()).copyright,
                children: "\uD83E\uDDD1\uD83C\uDFFB‍\uD83D\uDCBB Jay"
            }),
            /*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
                className: (Nav_module_default()).caret,
                src: Caret,
                alt: "Caret",
                width: 20,
                height: 20
...
/* harmony export */   AH: () => (/* binding */ getOpenSourcePosts),
/* harmony export */   AU: () => (/* binding */ getPostData),
/* harmony export */   Bd: () => (/* binding */ getAllPosts),
/* harmony export */   Qy: () => (/* binding */ getClassedPosts),
/* harmony export */   lW: () => (/* binding */ getErrorPosts),
...
const getOpenSourcePosts = async ()=>{
    return getAllPosts() //
    .then((posts)=>posts.filter((post)=>post.category.includes("OpenSource")).slice(0, 4));
};
const getErrorPosts = async ()=>{
    return getAllPosts() //
    .then((posts)=>posts.filter((post)=>post.category.includes("Error")).slice(0, 4));
};
const getClassedPosts = async (classedFile)=>{
    const allPost = await getAllPosts();
    const filteredPosts = allPost.filter((posts)=>posts.category.includes(classedFile));
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"src":"/_next/static/media/Caret.f0ad0bea.svg","height":800,"width":800,"blurWidth":0,"blurHeight":0});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"src":"/_next/static/media/myself.e2bb6821.png","height":355,"width":372,"blurDataURL":"data:image/png;base64,","blurWidth":8,"blurHeight":8});
...
"use strict";
module.exports = JSON.parse('[{"class":"Web","menu":[{"title":"JavaScript","svg":"Javascript"},{"title":"ReactJs","svg":"Reactjs"},{"title":"NextJs","svg":"Nextjs"},{"title":"TypeScript","svg":"Typescript"}]},{"class":"CS","menu":[{"title":"WebCS","svg":"WebCS"},{"title":"Error","svg":"Error"}]},{"class":"StyleSheet","menu":[{"title":"CSS","svg":"Css"},{"title":"Sass","svg":"Sass"}]},{"class":"OpenSource","menu":[{"title":"OpenSource","svg":"Codepen"}]},{"class":"App","menu":[{"title":"Flutter","svg":"Flutter"},{"title":"IOS","svg":"Apple"}]},{"class":"DB","menu":[{"title":"MySQL","svg":"Mysql"}]},{"class":"DevOps","menu":[{"title":"GIT","svg":"Git"},{"title":"CICD","svg":"Cicd"},{"title":"AWS","svg":"Aws"}]},{"class":"Server","menu":[{"title":"Express","svg":"Express"}]}]');
